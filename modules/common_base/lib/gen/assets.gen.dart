...
class $AssetsIconsGen {
  ...
  /// Directory path: packages/common_base/assets/icons
...
class $AssetsImagesGen {
  ...
  /// Directory path: packages/common_base/assets/images
  String get path => 'packages/common_base/assets/images';

  /// List of all assets
  List<AssetGenImage> get values => [lock, logo, profile];
}

class Assets {
  const Assets._();

  static const String package = 'common_base';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/common_base/$_assetName';
}
